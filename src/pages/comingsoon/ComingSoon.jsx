    ...
    <div className="flex box-border">
      <div className="w-9/12 left-side h-screen">
        <header className="flex justify-between mt-12 mx-44 headings">
          ...
          <div>
            <a href="/"><img src={Logo} alt="abacus logo"></img></a>
          </div>
        ...
        <footer className="ml-40 mt-8 overflow-hidden footer">
          ...
          <div>
            <a href='https://twitter.com/AbacusAfrica' target='blank'><FontAwesomeIcon icon={faTwitter} className="mr-6" /></a>
            <a href='https://www.facebook.com/AbacusAfrica?_rdc=1&_rdr' target='blank'><FontAwesomeIcon icon={faFacebook} className="mr-6" /></a>
            <a href='https://www.linkedin.com/company/abacus-africa/' target='blank'><FontAwesomeIcon icon={faLinkedinIn} className="mr-6" /></a>
            <a href='https://www.instagram.com/abacusafrica/' target='blank'><FontAwesomeIcon icon={faInstagram} /></a>
          </div>
        </footer>
      </div>
